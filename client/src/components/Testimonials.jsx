    ...
    <div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto px-4 py-8'>
            {testimonialsData.map((item, index) => (
                <div 
                className='bg-white rounded-xl p-6 drop-shadow-md max-w-lg m-auto hover:scale-105 transition-all duration-700 ease-in-out' 
                key={index}>
                    <p className='text-4xl text-gary-500'>”</p>
